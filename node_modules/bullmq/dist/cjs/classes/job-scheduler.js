...
class JobScheduler extends queue_base_1.QueueBase {
    ...
    async upsertJobScheduler(jobSchedulerId, repeatOpts, jobName, jobData, opts, { override }) {
        ...
        if (nextMillis) {
            if (override) {
                await this.scripts.addJobScheduler(multi, jobSchedulerId, nextMillis, {
                    name: jobName,
                ...
                await this.scripts.updateJobSchedulerNextMillis(multi, jobSchedulerId, nextMillis);
            }
            const job = this.createNextJob(multi, jobName, nextMillis, jobSchedulerId, Object.assign(Object.assign({}, opts), { repeat: filteredRepeatOpts }), jobData, iterationCount);
    ...
    createNextJob(client, name, nextMillis, jobSchedulerId, opts, data, currentCount) {
        ...
        const job = new job_1.Job(this, name, data, mergedOpts, jobId);
        job.addJob(client);
        return job;
    }
